...
import { BsPrefixRefForwardingComponent, AsProp } from 'react-bootstrap/cjs/helpers';
...
declare const _default: BsPrefixRefForwardingComponent<"form", FormProps> & {
    Group: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/cjs/FormGroup").FormGroupProps>;
    Control: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/cjs/FormControl").FormControlProps> & {
        Feedback: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/cjs/Feedback").FeedbackProps>;
    };
    Floating: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/cjs/FormFloating").FormFloatingProps>;
    Check: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/cjs/FormCheck").FormCheckProps> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/cjs/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/cjs/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    };
    Switch: BsPrefixRefForwardingComponent<BsPrefixRefForwardingComponent<"input", import("react-bootstrap/cjs/FormCheck").FormCheckProps> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/cjs/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/cjs/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    }, {
        ...
        feedbackType?: import("react-bootstrap/cjs/Feedback").FeedbackType | undefined;
        bsSwitchPrefix?: string | undefined;
    }> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/cjs/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/cjs/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    };
    Label: BsPrefixRefForwardingComponent<"label", import("react-bootstrap/cjs/FormLabel").FormLabelProps>;
    Text: BsPrefixRefForwardingComponent<"small", import("react-bootstrap/cjs/FormText").FormTextProps>;
    Range: React.ForwardRefExoticComponent<import("react-bootstrap/cjs/FormRange").FormRangeProps & React.RefAttributes<HTMLInputElement>>;
    Select: BsPrefixRefForwardingComponent<"select", import("react-bootstrap/cjs/FormSelect").FormSelectProps>;
    FloatingLabel: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/cjs/FloatingLabel").FloatingLabelProps>;
};
