...
import { BsPrefixRefForwardingComponent, AsProp } from 'react-bootstrap/helpers';
...
declare const _default: BsPrefixRefForwardingComponent<"form", FormProps> & {
    Group: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/FormGroup").FormGroupProps>;
    Control: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/FormControl").FormControlProps> & {
        Feedback: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/Feedback").FeedbackProps>;
    };
    Floating: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/FormFloating").FormFloatingProps>;
    Check: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/FormCheck").FormCheckProps> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    };
    Switch: BsPrefixRefForwardingComponent<BsPrefixRefForwardingComponent<"input", import("react-bootstrap/FormCheck").FormCheckProps> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    }, {
        ...
        feedbackType?: import("react-bootstrap/Feedback").FeedbackType | undefined;
        bsSwitchPrefix?: string | undefined;
    }> & {
        Input: BsPrefixRefForwardingComponent<"input", import("react-bootstrap/FormCheckInput").FormCheckInputProps>;
        Label: React.ForwardRefExoticComponent<import("react-bootstrap/FormCheckLabel").FormCheckLabelProps & React.RefAttributes<HTMLLabelElement>>;
    };
    Label: BsPrefixRefForwardingComponent<"label", import("react-bootstrap/FormLabel").FormLabelProps>;
    Text: BsPrefixRefForwardingComponent<"small", import("react-bootstrap/FormText").FormTextProps>;
    Range: React.ForwardRefExoticComponent<import("react-bootstrap/FormRange").FormRangeProps & React.RefAttributes<HTMLInputElement>>;
    Select: BsPrefixRefForwardingComponent<"select", import("react-bootstrap/FormSelect").FormSelectProps>;
    FloatingLabel: BsPrefixRefForwardingComponent<"div", import("react-bootstrap/FloatingLabel").FloatingLabelProps>;
};
